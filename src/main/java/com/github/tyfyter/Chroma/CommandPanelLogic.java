...
public abstract class CommandPanelLogic implements ICommandSender
{
    ...
    {
    	//tagCompound.setString("Commands", this.commandsStored);
    ...
    {
        //this.commandsStored = nbt.getString("Commands");
    ...
    {
        this.commandsStored[index] = command;
        this.successCount = 0;
    }
    ...
    public void trigger(World worldIn)
    {
        ...
        if (minecraftserver != null && minecraftserver.isAnvilFileSet() && minecraftserver.isCommandBlockEnabled())
        {
            ...
            try
            {
                ...
                //this.successCount = icommandmanager.executeCommand(this, this.commandsStored);
            }
            catch (Throwable throwable)
            {
                ...
                /*crashreportcategory.addCrashSectionCallable("Command", new Callable<String[]>()
                {
                    ...
                    {
                        return CommandPanelLogic.this.getCommands();
                    }
                });
                crashreportcategory.addCrashSectionCallable("Name", new Callable<String>()
                {
                    public String call() throws Exception
                    {
                        return CommandPanelLogic.this.getName();
                    }
                });
    ...
    public boolean tryOpenEditCommandBlock(EntityPlayer playerIn)
    {
        ...
        else
        {
            ...
            {
                this.openEditCommandPanel(playerIn);
            }

            return true;
        }
    }
    public void openEditCommandPanel(EntityPlayer playerIn)
    {
    }
