...
public class GuiCommandPanel extends GuiScreen
{
    ...
    private final CommandPanelLogic localCommandBlock;
    ...
    public GuiCommandPanel(CommandPanelLogic p_i45032_1_)
    {
    ...
    public void initGui()
    {
        ...
        this.commandTextField.setText(this.localCommandBlock.getCommands()[0]);
