...
public class ItemPotion extends Item
{
	...
	public ItemPotion setUnlocalizedName(String unlocalizedName)
	{
	...
	public List<PotionEffect> getEffects(ItemStack stack)
	{
		...
		{
			return Lists.<PotionEffect>newArrayList();
		}
	}
	...
	{
		if (!playerIn.capabilities.isCreativeMode && EnchantmentHelper.getEnchantmentLevel(Enchantment.infinity.effectId, stack) <= 0)
		{
			--stack.stackSize;
		}
	...
	public int getMaxItemUseDuration(ItemStack stack)
	{
		...
		Integer time = null;
		if(tags != null)time = tags.getInteger("UseTime");
		return time==null?32:time;
	}
	...
	public int getColorFromItemStack(ItemStack stack, int renderPass)
	{
		NBTTagCompound tags = stack.getTagCompound();
		Integer color = null;
		if(tags != null)color = tags.getInteger("Color");
		return (renderPass > 0 || color == null || tags.hasKey("Colour")) ? 16777215 : color;
	}
